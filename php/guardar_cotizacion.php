<?php
   ...
   $id_autor = $_SESSION['id'];
        ...
        // Insert some values
        try{
             $result = mysqli_query($con, "INSERT INTO cotizacion (cod_vendedor, n_infante, n_child, n_adult_s, n_adult_d, n_adult_t_c, id_titular, id_hotel, 
                                                            id_tarifa, id_plan, id_motivo, noche, acomodo, fecha_entrada, fecha_salida, id_autor)
                                                            VALUES ('$cod_vendedor' ,$n_infante,$n_child ,$n_adult_s ,$n_adult_d ,$n_adult_t_c,$id_titular ,$id_hotel ,$id_tarifa , $id_plan,
