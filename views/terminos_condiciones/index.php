  ...
  <main role="main">
    <div class="row">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" onclick="show_traer_tabla_terminos_condiciones()" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Buscar</a>
        </li>
      </ul>
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
          <div class="card mt-3">
            <h5 class="card-header">Términos y condiciones</h5>
            <div class="card-body">
              <form role="form" onsubmit="event.preventDefault(); return Guardarterminos_condiciones();" id="form_guardar" class="needs-validation">
                <div class="row">
                  <div class="col-md-12 mb-3" >
                    <label for="lastName">Titulo</label>
                    <input type="text" autocomplete="off" class="form-control " name="titulo" id="titulo" placeholder="" required>                    
                  </div>
                  <div class="col-md-12 mb-3" >
        ...
        <div class="responsive">
          <table id="tabla_terminos_condiciones" class="table table-striped table-bordered" style="width:100%">
            <thead>
                <tr>
                    <th>Nombre</th>
                    <th>Descripción</th>
...
$(function() {
  ...
  $("#menu_terminos_condiciones").addClass("active");
...
function Guardarterminos_condiciones() {
    ...
    type : 'POST',
    data: values,
    url: 'guardar_terminos_condiciones.php',
    beforeSend: function() {
...
function Editarterminos_condiciones() {
  ...
  function show_traer_tabla_terminos_condiciones(){
    setTimeout(() => {
      traer_tabla_terminos_condiciones()
    }, 100);
  }

  function traer_tabla_terminos_condiciones(){

    if ( ! $.fn.DataTable.isDataTable('#tabla_terminos_condiciones')) {
			  dtable = $("#tabla_terminos_condiciones").DataTable({
          "scrollY": true,
					"ajax": {
					...
					"deferRender": false,
					"data":{
            codigo:'traer_terminos_condiciones',
            parametro1: id_hotel,
            parametro2: "",
          },
