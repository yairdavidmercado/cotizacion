  ...
  <main role="main">
    <div class="row">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" onclick="show_traer_tabla_metodo_pago()" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Buscar</a>
        </li>
      </ul>
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
          <div class="card mt-3">
            ...
            <div class="card-body">
              <form role="form" onsubmit="event.preventDefault(); return GuardarMetodoPago();" id="form_guardar" class="needs-validation">
                <div class="row">
        ...
        <div class="responsive">
          <table id="tabla_metodo_pago" class="table table-striped table-bordered" style="width:100%">
            <thead>
                <tr>
                    <th>Nombre</th>
                    <th>Creación</th>
...
$(function() {
  ...
  $("#menu_metodo_pago").addClass("active");
...
function GuardarMetodoPago() {
  ...
  function show_traer_tabla_metodo_pago(){
    setTimeout(() => {
      traer_tabla_metodo_pago()
    }, 100);
  }

  function traer_tabla_metodo_pago(){

    if ( ! $.fn.DataTable.isDataTable('#tabla_metodo_pago')) {
			  dtable = $("#tabla_metodo_pago").DataTable({
          "scrollY": true,
					"ajax": {
					"url": "metodo_pago.php",
					"type": "POST",
